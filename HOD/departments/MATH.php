...
<?php
include "config.php";
$sql="SELECT * FROM tbl_hodprofile WHERE dept='Mathematics'";
...
if(mysqli_num_rows($result)>0)
{
    echo "<h1>PROFILE</h1>";
    {
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo $row['ph']."<br><br>";
            echo "<a href='MATHupdate.php?id=".$row['id']."'><button>Update</button></a>";
        }
    }
}
?> 
...
if(mysqli_num_rows($result)>0)
{
    ...
    <th>Response</th></tr>";
    {
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<td>
                <a href='mathresponse.php?id=".$row['id']."'><button>Provide Response</button></a></td>";
            echo "</tr>";
        }
        echo "</table>";
    }
