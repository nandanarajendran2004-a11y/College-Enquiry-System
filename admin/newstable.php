...
if(!$result){
    ...
    echo "<br>";
    echo "<h1 style='text-align: center;'>NEWS</h1>";
    echo "<div style='text-align:center;'>
    <button onclick=\"window.location.href='addnews.php'\" style=\"padding: 5px 10px;background-color:rgb(28,44,68);color:white;\">Add News</button>
</div><br>";
    echo "<table align='center' cellspacing='2' cellpadding='8'width='50%' height='55%' border='1' bordercolor='blue'style='text-align: center;'>";
    echo "<tr><th>SI NO</th><th>NEWS</th><th>EDIT</th></tr>";
    if(mysqli_num_rows($result)>0){
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<td>". $row['news']."</td>";
            echo "<td>
            <a href='editnews.php?id=".$row['id']."'><button>Edit</button></a></td>";
        echo "</tr>";
        }
        echo "</table>";
    }
