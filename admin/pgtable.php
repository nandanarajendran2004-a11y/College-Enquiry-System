...
if(!$result){
    ...
    echo "<br>";
    echo "<h1 style='text-align: center;'>PG DETAILS</h1>";
    echo "<div style='text-align:center;'>
    <button onclick=\"window.location.href='addpg.php'\" style=\"padding: 5px 10px;background-color:rgb(28,44,68);color:white;\">Add Course</button>
</div><br>";
    ...
    if(mysqli_num_rows($result)>0){
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<td>". $row['ph']."</td>";
            echo "<td>
            <a href='editpg.php?id=".$row['id']."'><button>Edit</button></a></td>";
        echo "</tr>";
        }
        echo "</table>";
    }
