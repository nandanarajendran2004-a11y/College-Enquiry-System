...
if(isset($_POST['submit']))
{
    ...
    $email=$_POST['email'];
    $ph=$_POST['ph'];
    $sql="UPDATE tbl_pg SET title='$title',hod='$hod',email='$email',ph='$ph' WHERE id='$id'";
    if(mysqli_query($conn,$sql)){
        echo "<script>alert('Edited Course');window.location='pgtable.php';</script>";
        }
        else{
...
{
    $id=$_GET['id'];
    $sql="SELECT * FROM tbl_pg WHERE id='$id'";
